...
const Navigationlinks = () => {
  return (
    <div className="w-full flex justify-center items-center lg:flex-row flex-col lg:gap-6 uppercase poppins-regular text-[1.4vw]">
      ...
      <div className="border-b-2 lg:h-20 h-0 overflow-hidden border-zinc-400 w-full flex lg:justify-center items-start flex-col
      ...
      {["home", "local", "tech", "articles", "write your own?"].map(
        (link, index) => (
          <a href="" className='border-b-2 border-zinc-500' key={index}>{link}</a>
        )
      )}
      </div>
    </div>
